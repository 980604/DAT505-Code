...
function render() {
	...
	for (var i = 0; i < eyesNum; i++) {
		...
		if (mouseX<1200) eyes[2].rotation.y = map_range(mouseX, 0, 1200, -1.14, 0);
		else eyes[2].rotation.y = map_range(mouseX, 1200, window.innerWidth, 0, 0.25);
		...
		if (mouseX<1200) eyes[4].rotation.y = map_range(mouseX, 0, 1200, -1.14, 0);
		else eyes[4].rotation.y = map_range(mouseX, 1200, window.innerWidth, 0, 0.25);
		if (mouseY<5) eyes[4].rotation.x = map_range(mouseY, 0, 5, -0.25, 0);
		else eyes[4].rotation.x = map_range(mouseY,5, window.innerHeight, 0, 1.14);
  }
