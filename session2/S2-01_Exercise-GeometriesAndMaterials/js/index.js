...
var texture =  new THREE.TextureLoader().load( 'textures/2019.jpg' );

var geometry2 = new THREE.SphereGeometry(60, 12, 12);
var texture2 =  new THREE.TextureLoader().load( 'textures/jg.jpg' );

var geometry3 = new THREE.ConeGeometry(90, 120, 60);
var texture3 =  new THREE.TextureLoader().load( 'textures/mh.jpg' );

var geometry4 = new THREE.ConeGeometry(90, 100, 60);
var texture4 =  new THREE.TextureLoader().load( 'textures/star.jpg' );
...
var mesh1 = new THREE.Mesh( geometry4, material3 );
